...
$mpdf->WriteHTML($html);
$mpdf->Output('asset/pdf/ID-Card-1.pdf', 'F');
...
if($foto) {
  ...
  $subjek = 'congrats, you got an id card!';
  $pesan = '
    <h5>You have completed the mission. Congratulations you are accepted and get an id card!</h5>
    <br>
  ...
  $mail->SMTPSecure = 'ssl';
  $mail->SMTPDebug = 2;
  $mail->AddAttachment('asset/pdf/ID-Card-1.pdf','ID-Card.pdf');
